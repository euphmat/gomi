...
# モンスターとドロップアイテムの実装
以下のリストにあるモンスターと、それらを倒した際にドロップするアイテムを実装してください。
...
## ステップ 1. モンスターのステータスの実装
以下のテンプレートを使用して、`js/definitions/monsters.js` にモンスターを実装してください。


http://googleusercontent.com/immersive_entry_chip/0

## 2. ドロップアイテムの実装
**重要:** このフェーズではアイテムの画像を用意しないでください。
