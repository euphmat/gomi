...
{ id: 'spider_cave_shield'     , name: 'ケイブスパイダーの盾'        , stats: { def:  35, mdef:  33 }, elements: {                        }, recipe: { price:  8000, materials: [{ id: 'spider_cave_venom',      amount: 25 }, { id: 'spider_cave_silk',       amount: 5 }] } },
{ id: 'spider_poison_shield'   , name: 'ポイズンスパイダーの盾'      , stats: { def:  39, mdef:  37 }, elements: {                        }, recipe: { price:  8500, materials: [{ id: 'spider_poison_venom',    amount: 25 }, { id: 'spider_poison_silk',     amount: 5 }] } },
{ id: 'spider_trapdoor_shield' , name: 'トラップドアスパイダーの盾'  , stats: { def:  43, mdef:  41 }, elements: {                        }, recipe: { price:  9000, materials: [{ id: 'spider_trapdoor_venom',  amount: 25 }, { id: 'spider_trapdoor_silk',   amount: 5 }] } },
...
{ id: 'swarm_spider_shield'    , name: 'スパイダースウォームの盾'    , stats: { def:  67, mdef:  65 }, elements: {                        }, recipe: { price: 12000, materials: [{ id: 'swarm_spider_venom',     amount: 25 }, { id: 'swarm_spider_silk',      amount: 5 }] } },
{ id: 'spider_dark_shield'     , name: 'ダークウィドウの盾'          , stats: { def:  71, mdef:  69 }, elements: {                        }, recipe: { price: 12500, materials: [{ id: 'spider_dark_venom',      amount: 25 }, { id: 'spider_dark_silk',       amount: 5 }] } },
...
{ id: 'boss_broodmother_shield', name: 'ブルードマザーの盾'          , stats: { def:  90, mdef:  88 }, elements: {                        }, recipe: { price: 15000, materials: [{ id: 'boss_broodmother_venom', amount: 25 }, { id: 'boss_broodmother_silk',  amount: 5 }] } },
