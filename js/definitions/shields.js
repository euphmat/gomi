...
export const SHIELDS = [
  ...
  { id: 'slime_king_shield',       name: 'キングスライムの盾',           stats: { def: 28, mdef: 28 }, elements: { water:   15, grass: 15 }, recipe: { price: 7000, materials: [{ id: 'slime_king_fluid',       amount: 25 }, { id: 'slime_king_jelly',       amount: 5 }] } },
