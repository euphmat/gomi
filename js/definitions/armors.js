...
export const ARMORS = [
  ...
  { id: 'slime_king_armor',       name: 'キングスライムアーマー',           stats: { def: 42, mdef: 42 }, elements: { fire: 15, water: 15, grass: 15 }, recipe: { price: 7000, materials: [{ id: 'slime_king_core',       amount: 25 }, { id: 'slime_king_fluid',       amount: 5 }] } },
