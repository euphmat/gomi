...
export const WEAPONS = [
  ...
  { id: 'slime_flower_bow',       name: 'フラワースライムボウ',             stats: { atk: 34, matk: 34 },          recipe: { price: 400,  materials: [{ id: 'slime_flower_jelly', amount: 3 }, { id: 'slime_flower_core', amount: 1 }] } },
  { id: 'slime_grass_staff',      name: 'グラススライムスタッフ',           stats: { atk: 38, matk: 38 },          recipe: { price: 450,  materials: [{ id: 'slime_grass_jelly', amount: 3 }, { id: 'slime_grass_core', amount: 1 }] } },
  { id: 'slime_green_sword',      name: 'グリーンスライムソード',           stats: { atk: 42, matk: 42 },          recipe: { price: 500,  materials: [{ id: 'slime_green_jelly', amount: 3 }, { id: 'slime_green_core', amount: 1 }] } },
  { id: 'slime_ice_bow',          name: 'アイススライムボウ',               stats: { atk: 46, matk: 46 },          recipe: { price: 550,  materials: [{ id: 'slime_ice_jelly', amount: 3 }, { id: 'slime_ice_core', amount: 1 }] } },
  { id: 'slime_king_staff',       name: 'キングスライムスタッフ',           stats: { atk: 50, matk: 50 },          recipe: { price: 600,  materials: [{ id: 'slime_king_jelly', amount: 3 }, { id: 'slime_king_core', amount: 1 }] } },
  { id: 'slime_red_sword',        name: 'レッドスライムソード',             stats: { atk: 54, matk: 54 },          recipe: { price: 650,  materials: [{ id: 'slime_red_jelly', amount: 3 }, { id: 'slime_red_core', amount: 1 }] } },
  { id: 'slime_thunder_bow',      name: 'サンダースライムボウ',             stats: { atk: 58, matk: 58 },          recipe: { price: 700,  materials: [{ id: 'slime_thunder_jelly', amount: 3 }, { id: 'slime_thunder_core', amount: 1 }] } },
  { id: 'slime_water_staff',      name: 'ウォータースライムスタッフ',       stats: { atk: 62, matk: 62 },          recipe: { price: 750,  materials: [{ id: 'slime_water_jelly', amount: 3 }, { id: 'slime_water_core', amount: 1 }] } },
  { id: 'slime_wind_sword',       name: 'ウインドスライムソード',           stats: { atk: 66, matk: 66 },          recipe: { price: 800,  materials: [{ id: 'slime_wind_jelly', amount: 3 }, { id: 'slime_wind_core', amount: 1 }] } },
