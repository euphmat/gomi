...
export const WEAPONS = [
    ...
    { id: 'rust_guard_sword', name: 'ラストガードソード', stats: { atk: 250, spd: 10 }, elements: { dark: 10 }, recipe: { price: 12000, materials: [{ id: 'mat_rust_sword', amount: 40 }, { id: 'mat_grudge_soul', amount: 10 }] } },
    { id: 'dust_maid_broom', name: 'ダストメイドブルーム', stats: { atk: 100, matk: 250, spd: 50 }, elements: { wind: 20 }, recipe: { price: 11000, materials: [{ id: 'mat_maid_broom', amount: 40 }, { id: 'mat_spider_web', amount: 10 }] } },
    { id: 'cursed_chandelier_flail', name: 'カースドフレイル', stats: { atk: 280, spd: -10 }, elements: { fire: 30 }, recipe: { price: 13000, materials: [{ id: 'mat_heavy_chain', amount: 40 }, { id: 'mat_blue_flame', amount: 10 }] } },
    { id: 'wizard_library_grimoire', name: '禁断の魔導書', stats: { atk: 50, matk: 300, spd: 15 }, elements: { dark: 30 }, recipe: { price: 14000, materials: [{ id: 'mat_forbidden_page', amount: 40 }, { id: 'mat_madness_cover', amount: 10 }] } },
    { id: 'hollow_president_cane', name: 'プレジデントケイン', stats: { atk: 200, matk: 280, spd: 20 }, elements: { earth: 20 }, recipe: { price: 13500, materials: [{ id: 'mat_gold_frame', amount: 40 }, { id: 'mat_hollow_eye', amount: 10 }] } },
    { id: 'shadow_hound_claw', name: 'シャドウハウンドクロウ', stats: { atk: 260, spd: 80 }, elements: { dark: 20 }, recipe: { price: 14500, materials: [{ id: 'mat_hound_fang', amount: 40 }, { id: 'mat_shadow_fur', amount: 10 }] } },
    { id: 'requiem_rat_fang', name: 'レクイエムファング', stats: { atk: 220, spd: 60 }, elements: { dark: 20 }, recipe: { price: 12500, materials: [{ id: 'mat_rat_tail', amount: 40 }, { id: 'mat_plague_blood', amount: 10 }] } },
    { id: 'glitter_golden_bow', name: '黄金の成金弓', stats: { atk: 350, matk: 350, spd: 50 }, elements: { light: 30 }, recipe: { price: 50000, materials: [{ id: 'mat_pure_gold', amount: 40 }, { id: 'mat_glitter_gem', amount: 10 }] } },
    { id: 'death_imperator_greatsword', name: 'デスインペレイター', stats: { atk: 400, spd: -20 }, elements: { dark: 40 }, recipe: { price: 60000, materials: [{ id: 'mat_grudge_greatsword', amount: 50 }, { id: 'mat_broken_crown', amount: 10 }] } },
    { id: 'necro_origin_scythe', name: 'ネクロオリジンサイズ', stats: { atk: 320, matk: 450, spd: 30 }, elements: { dark: 50 }, recipe: { price: 85000, materials: [{ id: 'mat_forbidden_grimoire', amount: 50 }, { id: 'mat_origin_core', amount: 10 }] } },
