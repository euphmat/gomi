...
const equipIds = { rightHand: [], leftHand: [], armor: [] };
...
const BASE_TEMPLATE = {
  ...
  jp:  { current: 0,   max: getJobExpToNext(1) },
  modifiers: [],
...
export const SEED_CHARACTERS = [
  { ...BASE_TEMPLATE, id: 1,
    name: '村人A',
    baseStats: { atk: 1, def: 1, matk: 1, mdef: 1, spd: 2 },
    equipment: { rightHand: equipIds.rightHand[0] || null, leftHand: equipIds.leftHand[0] || null, armor: equipIds.armor[0] || null, accessory1: null, accessory2: null, },
  },
  { ...BASE_TEMPLATE, id: 2,
    name: '村人B',
    baseStats: { atk: 1, def: 1, matk: 1, mdef: 1, spd: 2 },
    equipment: { rightHand: equipIds.rightHand[1] || null, leftHand: equipIds.leftHand[1] || null, armor: equipIds.armor[1] || null, accessory1: null, accessory2: null, },
  },
  { ...BASE_TEMPLATE, id: 3,
    name: '村人C',
    baseStats: { atk: 1, def: 1, matk: 1, mdef: 1, spd: 2 },
    equipment: { rightHand: equipIds.rightHand[2] || null, leftHand: equipIds.leftHand[2] || null, armor: equipIds.armor[2] || null, accessory1: null, accessory2: null, },
  },
  { ...BASE_TEMPLATE, id: 4,
    name: '村人D',
    baseStats: { atk: 1, def: 1, matk: 1, mdef: 1, spd: 2 },
    equipment: { rightHand: equipIds.rightHand[3] || null, leftHand: equipIds.leftHand[3] || null, armor: equipIds.armor[3] || null, accessory1: null, accessory2: null, },
  },
];
