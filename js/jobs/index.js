...
export const JOB_STAT_MULTIPLIER = {
  [norvice.id]:      { hp: 0.8, mp: 0.8, atk: 0.8, def: 0.8, matk: 0.8, mdef: 0.8, spd: 0.8 },
  [knight.id]:       { hp: 2.0, mp: 0.8, atk: 1.0, def: 1.5, matk: 0.1, mdef: 0.4, spd: 0.9 },
  ...
  [ranger.id]:       { hp: 1.0, mp: 1.0, atk: 0.8, def: 0.9, matk: 0.6, mdef: 0.8, spd: 1.0 },
  ...
  [dancer.id]:       { hp: 0.8, mp: 1.3, atk: 0.5, def: 0.7, matk: 1.3, mdef: 0.7, spd: 1.0 },
  ...
  [assassin.id]:     { hp: 0.75, mp: 1.1, atk: 1.7, def: 0.65, matk: 0.3, mdef: 0.65, spd: 1.6 }
};
