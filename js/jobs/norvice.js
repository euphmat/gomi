  ...
  skills: [
    {
      ...
      maxLevel: 10,
      levels: [
        { level:  1, spCost: 1, mpCost: 4, healAmount: 10 },
        { level:  2, spCost: 1, mpCost: 8, healAmount: 15 },
        { level:  3, spCost: 1, mpCost: 12, healAmount: 22 },
        { level:  4, spCost: 2, mpCost: 16, healAmount: 30 },
        { level:  5, spCost: 2, mpCost: 20, healAmount: 40 },
        { level:  6, spCost: 2, mpCost: 24, healAmount: 52 },
        { level:  7, spCost: 3, mpCost: 28, healAmount: 66 },
        { level:  8, spCost: 3, mpCost: 36, healAmount: 82 },
        { level:  9, spCost: 3, mpCost: 44, healAmount: 100 },
        { level: 10, spCost: 5, mpCost: 52, healAmount: 120 }
      ],
    ...
    },
    {
      ...
      maxLevel: 10,
      levels: [
        { level:  1, spCost: 1, mpCost: 8, multiplier: 1.1 },
        { level:  2, spCost: 1, mpCost: 12, multiplier: 1.2 },
        { level:  3, spCost: 1, mpCost: 16, multiplier: 1.3 },
        { level:  4, spCost: 2, mpCost: 20, multiplier: 1.4 },
        { level:  5, spCost: 2, mpCost: 24, multiplier: 1.5 },
        { level:  6, spCost: 2, mpCost: 28, multiplier: 1.6 },
        { level:  7, spCost: 3, mpCost: 32, multiplier: 1.7 },
        { level:  8, spCost: 3, mpCost: 36, multiplier: 1.8 },
        { level:  9, spCost: 3, mpCost: 40, multiplier: 1.9 },
        { level: 10, spCost: 5, mpCost: 48, multiplier: 2.0 }
      ],
    ...
    },
    {
      ...
      maxLevel: 10,
      levels: [
        { level:  1, spCost: 1, mpCost: 8, reducePercent: 10, turns: 2 },
        { level:  2, spCost: 1, mpCost: 8, reducePercent: 12, turns: 2 },
        { level:  3, spCost: 1, mpCost: 12, reducePercent: 14, turns: 2 },
        { level:  4, spCost: 2, mpCost: 12, reducePercent: 16, turns: 3 },
        { level:  5, spCost: 2, mpCost: 16, reducePercent: 18, turns: 3 },
        { level:  6, spCost: 2, mpCost: 16, reducePercent: 20, turns: 3 },
        { level:  7, spCost: 3, mpCost: 20, reducePercent: 22, turns: 4 },
        { level:  8, spCost: 3, mpCost: 20, reducePercent: 24, turns: 4 },
        { level:  9, spCost: 3, mpCost: 24, reducePercent: 26, turns: 4 },
        { level: 10, spCost: 5, mpCost: 32, reducePercent: 30, turns: 5 }
      ],
    ...
    },
    {
      ...
      maxLevel: 10,
      levels: [
        { level:  1, spCost: 1, mpCost: 16, multiplier: 0.5 },
        { level:  2, spCost: 1, mpCost: 20, multiplier: 0.55 },
        { level:  3, spCost: 1, mpCost: 24, multiplier: 0.6 },
        { level:  4, spCost: 2, mpCost: 28, multiplier: 0.65 },
        { level:  5, spCost: 2, mpCost: 32, multiplier: 0.7 },
        { level:  6, spCost: 2, mpCost: 36, multiplier: 0.75 },
        { level:  7, spCost: 3, mpCost: 40, multiplier: 0.8 },
        { level:  8, spCost: 3, mpCost: 44, multiplier: 0.85 },
        { level:  9, spCost: 3, mpCost: 48, multiplier: 0.9 },
        { level: 10, spCost: 5, mpCost: 60, multiplier: 1.0 }
      ],
