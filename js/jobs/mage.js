...
export const mage = {
  ...
  skills: [
    ...
    },
    {
      ...
      maxLevel: 10,
      levels: [
        { level:  1, spCost: 2, mpCost: 45, multiplier: 0.34, hits: 3 },
        { level:  2, spCost: 2, mpCost: 56, multiplier: 0.28, hits: 4 },
        { level:  3, spCost: 2, mpCost: 64, multiplier: 0.30, hits: 4 },
        { level:  4, spCost: 3, mpCost: 74, multiplier: 0.26, hits: 5 },
        { level:  5, spCost: 3, mpCost: 86, multiplier: 0.24, hits: 6 },
        { level:  6, spCost: 3, mpCost: 98, multiplier: 0.22, hits: 7 },
        { level:  7, spCost: 4, mpCost: 106, multiplier: 0.20, hits: 8 },
    ...
    },
    {
      ...
      maxLevel: 10,
      levels: [
        { level:  1, spCost: 2, mpCost: 45, multiplier: 1.0 },
        { level:  2, spCost: 2, mpCost: 56, multiplier: 1.1 },
        { level:  3, spCost: 2, mpCost: 64, multiplier: 1.2 },
        { level:  4, spCost: 3, mpCost: 74, multiplier: 1.3 },
        { level:  5, spCost: 3, mpCost: 86, multiplier: 1.4 },
        { level:  6, spCost: 3, mpCost: 90, multiplier: 1.5 },
        { level:  7, spCost: 4, mpCost: 106, multiplier: 1.6 },
