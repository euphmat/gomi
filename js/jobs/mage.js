...
export const mage = {
  ...
  skills: [
    // ─── Active Skills ──────────────────────────────────────
    {
      ...
      maxLevel: 10,
      levels: [
        { level:  1, spCost: 1, mpCost: 16, multiplier: 1.2 },
        { level:  2, spCost: 1, mpCost: 20, multiplier: 1.3 },
        { level:  3, spCost: 1, mpCost: 24, multiplier: 1.4 },
        { level:  4, spCost: 2, mpCost: 28, multiplier: 1.5 },
        { level:  5, spCost: 2, mpCost: 32, multiplier: 1.6 },
        { level:  6, spCost: 2, mpCost: 36, multiplier: 1.7 },
        { level:  7, spCost: 3, mpCost: 40, multiplier: 1.8 },
        { level:  8, spCost: 3, mpCost: 44, multiplier: 1.9 },
        { level:  9, spCost: 3, mpCost: 48, multiplier: 2.0 },
    ...
    },
    {
      ...
      maxLevel: 10,
      levels: [
        { level:  1, spCost: 1, mpCost: 16, mdefAmount: 10, turns: 3 },
        { level:  2, spCost: 1, mpCost: 20, mdefAmount: 13, turns: 3 },
        { level:  3, spCost: 1, mpCost: 24, mdefAmount: 16, turns: 3 },
        { level:  4, spCost: 2, mpCost: 28, mdefAmount: 19, turns: 3 },
        { level:  5, spCost: 2, mpCost: 32, mdefAmount: 22, turns: 3 },
        { level:  6, spCost: 2, mpCost: 36, mdefAmount: 25, turns: 3 },
        { level:  7, spCost: 3, mpCost: 40, mdefAmount: 28, turns: 4 },
        { level:  8, spCost: 3, mpCost: 44, mdefAmount: 32, turns: 4 },
        { level:  9, spCost: 3, mpCost: 48, mdefAmount: 36, turns: 4 },
        { level: 10, spCost: 5, mpCost: 60, mdefAmount: 40, turns: 5 }
      ],
    ...
    },
    {
      ...
      maxLevel: 10,
      levels: [
        { level:  1, spCost: 2, mpCost: 60, multiplier: 1.0 },
        { level:  2, spCost: 2, mpCost: 72, multiplier: 1.1 },
        { level:  3, spCost: 2, mpCost: 88, multiplier: 1.2 },
        { level:  4, spCost: 3, mpCost: 108, multiplier: 1.3 },
        { level:  5, spCost: 3, mpCost: 132, multiplier: 1.4 },
        { level:  6, spCost: 3, mpCost: 160, multiplier: 1.5 },
        { level:  7, spCost: 4, mpCost: 192, multiplier: 1.6 },
        { level:  8, spCost: 4, mpCost: 228, multiplier: 1.7 },
        { level:  9, spCost: 4, mpCost: 268, multiplier: 1.8 },
        { level: 10, spCost: 6, mpCost: 320, multiplier: 2.0 }
      ],
