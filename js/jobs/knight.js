...
export const knight = {
  ...
  skills: [
    // ─── Active Skills ──────────────────────────────────────
    {
      ...
      maxLevel: 10,
      levels: [
        { level:  1, spCost: 1, mpCost: 12, turns: 2, chance: 20 },
        { level:  2, spCost: 1, mpCost: 16, turns: 2, chance: 25 },
        { level:  3, spCost: 1, mpCost: 20, turns: 2, chance: 28 },
        { level:  4, spCost: 2, mpCost: 24, turns: 3, chance: 30 },
        { level:  5, spCost: 2, mpCost: 28, turns: 3, chance: 33 },
        { level:  6, spCost: 2, mpCost: 32, turns: 3, chance: 36 },
        { level:  7, spCost: 3, mpCost: 36, turns: 4, chance: 40 },
        { level:  8, spCost: 3, mpCost: 40, turns: 4, chance: 43 },
        { level:  9, spCost: 3, mpCost: 44, turns: 4, chance: 46 },
        { level: 10, spCost: 5, mpCost: 56, turns: 5, chance: 50 }
      ],
    ...
    },
    {
      ...
      maxLevel: 10,
      levels: [
        { level:  1, spCost: 1, mpCost: 16, defPercent: 10, turns: 3 },
        { level:  2, spCost: 1, mpCost: 20, defPercent: 13, turns: 3 },
        { level:  3, spCost: 1, mpCost: 24, defPercent: 16, turns: 3 },
        { level:  4, spCost: 2, mpCost: 28, defPercent: 19, turns: 3 },
        { level:  5, spCost: 2, mpCost: 32, defPercent: 22, turns: 3 },
        { level:  6, spCost: 2, mpCost: 36, defPercent: 25, turns: 3 },
        { level:  7, spCost: 3, mpCost: 40, defPercent: 28, turns: 4 },
        { level:  8, spCost: 3, mpCost: 44, defPercent: 32, turns: 4 },
        { level:  9, spCost: 3, mpCost: 48, defPercent: 36, turns: 4 },
        { level: 10, spCost: 5, mpCost: 60, defPercent: 40, turns: 5 }
      ],
    ...
    },
    {
      ...
      maxLevel: 10,
      levels: [
        { level:  1, spCost: 1, mpCost: 12, multiplier: 1.0 },
        { level:  2, spCost: 1, mpCost: 16, multiplier: 1.05 },
        { level:  3, spCost: 1, mpCost: 20, multiplier: 1.1 },
        { level:  4, spCost: 2, mpCost: 24, multiplier: 1.15 },
        { level:  5, spCost: 2, mpCost: 28, multiplier: 1.2 },
        { level:  6, spCost: 2, mpCost: 32, multiplier: 1.25 },
        { level:  7, spCost: 3, mpCost: 36, multiplier: 1.3 },
        { level:  8, spCost: 3, mpCost: 40, multiplier: 1.35 },
        { level:  9, spCost: 3, mpCost: 44, multiplier: 1.4 },
        { level: 10, spCost: 5, mpCost: 56, multiplier: 1.5 }
      ],
