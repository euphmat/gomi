  ...
  skills: [
    // ─── Active Skills ──────────────────────────────────────
    {
      ...
      levels: [
        ...
        { level:  2, spCost: 1, mpCost: 10, multiplier: 0.55, chance: 35 },
        { level:  3, spCost: 1, mpCost: 12, multiplier: 0.6, chance: 40 },
        { level:  4, spCost: 2, mpCost: 14, multiplier: 0.65, chance: 45 },
        { level:  5, spCost: 2, mpCost: 16, multiplier: 0.7, chance: 50 },
        { level:  6, spCost: 2, mpCost: 18, multiplier: 0.75, chance: 55 },
        { level:  7, spCost: 3, mpCost: 20, multiplier: 0.8, chance: 60 },
        { level:  8, spCost: 3, mpCost: 22, multiplier: 0.85, chance: 65 },
        { level:  9, spCost: 3, mpCost: 24, multiplier: 0.9, chance: 70 },
    ...
    },
    {
      ...
      levels: [
        ...
        { level:  2, spCost: 1, mpCost: 12, multiplier: 0.11, minHits: 3, maxHits: 6 },
        { level:  3, spCost: 1, mpCost: 14, multiplier: 0.12, minHits: 4, maxHits: 7 },
        { level:  4, spCost: 2, mpCost: 16, multiplier: 0.13, minHits: 4, maxHits: 8 },
        { level:  5, spCost: 2, mpCost: 18, multiplier: 0.14, minHits: 5, maxHits: 9 },
        { level:  6, spCost: 2, mpCost: 20, multiplier: 0.15, minHits: 5, maxHits: 10 },
        { level:  7, spCost: 3, mpCost: 24, multiplier: 0.16, minHits: 6, maxHits: 11 },
        { level:  8, spCost: 3, mpCost: 28, multiplier: 0.18, minHits: 6, maxHits: 12 },
        { level:  9, spCost: 3, mpCost: 32, multiplier: 0.20, minHits: 7, maxHits: 14 },
    ...
    },
    {
      ...
      levels: [
        ...
        { level:  2, spCost: 2, mpCost: 17, chance: 35 },
        { level:  3, spCost: 2, mpCost: 19, chance: 40 },
        { level:  4, spCost: 3, mpCost: 21, chance: 45 },
        { level:  5, spCost: 3, mpCost: 23, chance: 50 },
        { level:  6, spCost: 3, mpCost: 25, chance: 55 },
        { level:  7, spCost: 4, mpCost: 28, chance: 60 },
        { level:  8, spCost: 4, mpCost: 31, chance: 65 },
        { level:  9, spCost: 4, mpCost: 35, chance: 70 },
    ...
    },
    {
      ...
      levels: [
        ...
        { level:  2, spCost: 3, mpCost: 28, chance: 35, minAilments: 1, maxAilments: 2 },
        { level:  3, spCost: 3, mpCost: 31, chance: 40, minAilments: 1, maxAilments: 2 },
        { level:  4, spCost: 4, mpCost: 34, chance: 45, minAilments: 1, maxAilments: 2 },
        { level:  5, spCost: 4, mpCost: 37, chance: 50, minAilments: 2, maxAilments: 2 },
        { level:  6, spCost: 4, mpCost: 40, chance: 55, minAilments: 2, maxAilments: 3 },
        { level:  7, spCost: 5, mpCost: 45, chance: 60, minAilments: 2, maxAilments: 3 },
        { level:  8, spCost: 5, mpCost: 50, chance: 65, minAilments: 2, maxAilments: 3 },
        { level:  9, spCost: 5, mpCost: 55, chance: 70, minAilments: 2, maxAilments: 4 },
