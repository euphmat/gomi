...
export const dancer = {
  ...
  skills: [
    // ─── Active Skills ──────────────────────────────────────
    {
      ...
      maxLevel: 10,
      levels: [
        { level:  1, spCost: 1, mpCost: 32, multiplier: 0.5, chance: 30 },
        { level:  2, spCost: 1, mpCost: 40, multiplier: 0.55, chance: 35 },
        { level:  3, spCost: 1, mpCost: 48, multiplier: 0.6, chance: 40 },
        { level:  4, spCost: 2, mpCost: 56, multiplier: 0.65, chance: 45 },
        { level:  5, spCost: 2, mpCost: 64, multiplier: 0.7, chance: 50 },
        { level:  6, spCost: 2, mpCost: 72, multiplier: 0.75, chance: 55 },
        { level:  7, spCost: 3, mpCost: 80, multiplier: 0.8, chance: 60 },
        { level:  8, spCost: 3, mpCost: 88, multiplier: 0.85, chance: 65 },
        { level:  9, spCost: 3, mpCost: 96, multiplier: 0.9, chance: 70 },
        { level: 10, spCost: 5, mpCost: 120, multiplier: 1.0, chance: 80 }
      ],
    ...
    },
    {
      ...
      maxLevel: 10,
      levels: [
        { level:  1, spCost: 1, mpCost: 40, multiplier: 0.10, minHits: 3, maxHits: 5 },
        { level:  2, spCost: 1, mpCost: 48, multiplier: 0.11, minHits: 3, maxHits: 6 },
        { level:  3, spCost: 1, mpCost: 56, multiplier: 0.12, minHits: 4, maxHits: 7 },
        { level:  4, spCost: 2, mpCost: 64, multiplier: 0.13, minHits: 4, maxHits: 8 },
        { level:  5, spCost: 2, mpCost: 72, multiplier: 0.14, minHits: 5, maxHits: 9 },
        { level:  6, spCost: 2, mpCost: 80, multiplier: 0.15, minHits: 5, maxHits: 10 },
        { level:  7, spCost: 3, mpCost: 96, multiplier: 0.16, minHits: 6, maxHits: 11 },
        { level:  8, spCost: 3, mpCost: 112, multiplier: 0.18, minHits: 6, maxHits: 12 },
        { level:  9, spCost: 3, mpCost: 128, multiplier: 0.20, minHits: 7, maxHits: 14 },
        { level: 10, spCost: 5, mpCost: 160, multiplier: 0.25, minHits: 8, maxHits: 16 }
      ],
    ...
    },
    {
      ...
      maxLevel: 10,
      levels: [
        { level:  1, spCost: 2, mpCost: 60, chance: 30 },
        { level:  2, spCost: 2, mpCost: 68, chance: 35 },
        { level:  3, spCost: 2, mpCost: 76, chance: 40 },
        { level:  4, spCost: 3, mpCost: 84, chance: 45 },
        { level:  5, spCost: 3, mpCost: 92, chance: 50 },
        { level:  6, spCost: 3, mpCost: 100, chance: 55 },
        { level:  7, spCost: 4, mpCost: 112, chance: 60 },
        { level:  8, spCost: 4, mpCost: 124, chance: 65 },
        { level:  9, spCost: 4, mpCost: 140, chance: 70 },
        { level: 10, spCost: 6, mpCost: 160, chance: 80 }
      ],
    ...
    },
    {
      ...
      maxLevel: 10,
      levels: [
        { level:  1, spCost: 3, mpCost: 100, chance: 30, minAilments: 1, maxAilments: 1 },
        { level:  2, spCost: 3, mpCost: 112, chance: 35, minAilments: 1, maxAilments: 2 },
        { level:  3, spCost: 3, mpCost: 124, chance: 40, minAilments: 1, maxAilments: 2 },
        { level:  4, spCost: 4, mpCost: 136, chance: 45, minAilments: 1, maxAilments: 2 },
        { level:  5, spCost: 4, mpCost: 148, chance: 50, minAilments: 2, maxAilments: 2 },
        { level:  6, spCost: 4, mpCost: 160, chance: 55, minAilments: 2, maxAilments: 3 },
        { level:  7, spCost: 5, mpCost: 180, chance: 60, minAilments: 2, maxAilments: 3 },
        { level:  8, spCost: 5, mpCost: 200, chance: 65, minAilments: 2, maxAilments: 3 },
        { level:  9, spCost: 5, mpCost: 220, chance: 70, minAilments: 2, maxAilments: 4 },
        { level: 10, spCost: 7, mpCost: 260, chance: 85, minAilments: 3, maxAilments: 5 }
      ],
