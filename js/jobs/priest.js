...
export const priest = {
  ...
  skills: [
    // ─── Active Skills ──────────────────────────────────────
    {
      ...
      maxLevel: 10,
      levels: [
        { level:  1, spCost: 1, mpCost: 12, healAmount: 30 },
        { level:  2, spCost: 1, mpCost: 16, healAmount: 45 },
        { level:  3, spCost: 1, mpCost: 20, healAmount: 60 },
        { level:  4, spCost: 2, mpCost: 24, healAmount: 80 },
        { level:  5, spCost: 2, mpCost: 28, healAmount: 100 },
        { level:  6, spCost: 2, mpCost: 32, healAmount: 125 },
        { level:  7, spCost: 3, mpCost: 36, healAmount: 150 },
        { level:  8, spCost: 3, mpCost: 44, healAmount: 180 },
        { level:  9, spCost: 3, mpCost: 52, healAmount: 220 },
        { level: 10, spCost: 5, mpCost: 60, healAmount: 260 }
      ],
    ...
    },
    {
      ...
      maxLevel: 10,
      levels: [
        { level:  1, spCost: 2, mpCost: 40, reviveHp: 10 },
        { level:  2, spCost: 2, mpCost: 48, reviveHp: 20 },
        { level:  3, spCost: 2, mpCost: 56, reviveHp: 30 },
        { level:  4, spCost: 3, mpCost: 64, reviveHp: 40 },
        { level:  5, spCost: 3, mpCost: 72, reviveHp: 50 },
        { level:  6, spCost: 3, mpCost: 80, reviveHp: 65 },
        { level:  7, spCost: 4, mpCost: 88, reviveHp: 80 },
        { level:  8, spCost: 4, mpCost: 96, reviveHp: 100 },
        { level:  9, spCost: 4, mpCost: 104, reviveHp: 120 },
        { level: 10, spCost: 5, mpCost: 120, reviveHp: 150 }
      ],
    ...
    },
    {
      ...
      maxLevel: 10,
      levels: [
        { level:  1, spCost: 1, mpCost: 16 },
        { level:  2, spCost: 1, mpCost: 16 },
        { level:  3, spCost: 1, mpCost: 16 },
        { level:  4, spCost: 2, mpCost: 16 },
        { level:  5, spCost: 2, mpCost: 16 },
        { level:  6, spCost: 2, mpCost: 16 },
        { level:  7, spCost: 3, mpCost: 12 },
        { level:  8, spCost: 3, mpCost: 12 },
        { level:  9, spCost: 3, mpCost: 12 },
        { level: 10, spCost: 5, mpCost: 8 }
      ],
    ...
    },
    {
      ...
      maxLevel: 10,
      levels: [
        { level:  1, spCost: 1, mpCost: 20, multiplier: 1.3 },
        { level:  2, spCost: 1, mpCost: 24, multiplier: 1.4 },
        { level:  3, spCost: 1, mpCost: 28, multiplier: 1.5 },
        { level:  4, spCost: 2, mpCost: 32, multiplier: 1.6 },
        { level:  5, spCost: 2, mpCost: 36, multiplier: 1.7 },
        { level:  6, spCost: 2, mpCost: 40, multiplier: 1.8 },
        { level:  7, spCost: 3, mpCost: 44, multiplier: 1.9 },
        { level:  8, spCost: 3, mpCost: 48, multiplier: 2.0 },
        { level:  9, spCost: 3, mpCost: 52, multiplier: 2.1 },
        { level: 10, spCost: 5, mpCost: 64, multiplier: 2.4 }
      ],
    ...
    },
    {
      ...
      maxLevel: 10,
      levels: [
        { level:  1, spCost: 2, mpCost: 48, healAmount: 25 },
        { level:  2, spCost: 2, mpCost: 60, healAmount: 35 },
        { level:  3, spCost: 2, mpCost: 72, healAmount: 50 },
        { level:  4, spCost: 3, mpCost: 88, healAmount: 70 },
        { level:  5, spCost: 3, mpCost: 104, healAmount: 95 },
        { level:  6, spCost: 3, mpCost: 120, healAmount: 125 },
        { level:  7, spCost: 4, mpCost: 140, healAmount: 160 },
        { level:  8, spCost: 4, mpCost: 160, healAmount: 200 },
        { level:  9, spCost: 4, mpCost: 184, healAmount: 245 },
        { level: 10, spCost: 6, mpCost: 220, healAmount: 300 }
      ],
