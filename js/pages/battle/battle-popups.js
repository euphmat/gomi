...
export const BATTLE_VALUE_STYLES = Object.freeze({
  ...
  [BATTLE_VALUE_TYPES.HP_RECOVERY]: { color: '#22c55e', textShadow: '-2px -2px 0 #14532d, 2px -2px 0 #14532d, -2px 2px 0 #14532d, 2px 2px 0 #14532d, 0 4px 6px rgba(0,0,0,0.8)' },
  [BATTLE_VALUE_TYPES.MP_RECOVERY]: { color: '#3b82f6', textShadow: '-2px -2px 0 #172554, 2px -2px 0 #172554, -2px 2px 0 #172554, 2px 2px 0 #172554, 0 4px 6px rgba(0,0,0,0.8)' },
