...
export function renderGuildPage() {
  ...
  // タブの定義 (宿屋を一番左に追加)
  const TABS = [
    { id: 'inn', label: '宿屋', icon: 'hotel', activeClass: 'border-rose-400/45 bg-rose-950/55 text-rose-300 shadow-[inset_0_1px_1px_rgba(255,255,255,0.12),_0_0_12px_rgba(251,113,133,0.18)]', idleClass: 'hover:border-rose-500/35 hover:bg-rose-950/30 hover:text-rose-300' },
    { id: 'skill', label: '修練場', icon: 'sports_martial_arts', activeClass: 'border-orange-400/45 bg-orange-950/55 text-orange-300 shadow-[inset_0_1px_1px_rgba(255,255,255,0.12),_0_0_12px_rgba(251,146,60,0.18)]', idleClass: 'hover:border-orange-500/35 hover:bg-orange-950/30 hover:text-orange-300' },
    { id: 'job', label: '神殿', icon: 'church', activeClass: 'border-violet-400/45 bg-violet-950/55 text-violet-300 shadow-[inset_0_1px_1px_rgba(255,255,255,0.12),_0_0_12px_rgba(167,139,250,0.18)]', idleClass: 'hover:border-violet-500/35 hover:bg-violet-950/30 hover:text-violet-300' },
    { id: 'ranch', label: '牧場', icon: 'pets', activeClass: 'border-pink-400/45 bg-pink-950/55 text-pink-300 shadow-[inset_0_1px_1px_rgba(255,255,255,0.12),_0_0_12px_rgba(244,114,182,0.18)]', idleClass: 'hover:border-pink-500/35 hover:bg-pink-950/30 hover:text-pink-300' },
    { id: 'mine', label: '鉱山', icon: 'landscape', activeClass: 'border-amber-400/45 bg-amber-950/55 text-amber-300 shadow-[inset_0_1px_1px_rgba(255,255,255,0.12),_0_0_12px_rgba(251,191,36,0.18)]', idleClass: 'hover:border-amber-500/35 hover:bg-amber-950/30 hover:text-amber-300' }
  ];
  let activeTabId = 'inn';
