...
export function renderGuildPage() {
  return `
    <div class="flex flex-col items-center justify-center h-full gap-4 p-6">
      <span class="material-symbols-outlined text-6xl text-gray-600">groups</span>
      <h2 class="text-xl font-bold text-gray-400">Guild</h2>
      <p class="text-sm text-gray-600 text-center">ギルド画面は準備中です</p>
